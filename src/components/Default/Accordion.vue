          ...
          <ul class="tabs-links">
            <li class="is-revealing">
              <a href="#tab-1" class="tab-link is-active">
                <g-image src="~/assets/images/tabs-icon-01.svg" alt="Tabs icon 01" />
                <span class="h4 m-0">Amazing features</span>
              </a>
            </li>
            <li class="is-revealing">
              <a href="#tab-2" class="tab-link">
                <g-image src="~/assets/images/tabs-icon-02.svg" alt="Tabs icon 02" />
                <span class="h4 m-0">Endless possibilities</span>
              </a>
            </li>
            <li class="is-revealing">
              <a href="#tab-3" class="tab-link">
                <g-image src="~/assets/images/tabs-icon-03.svg" alt="Tabs icon 03" />
